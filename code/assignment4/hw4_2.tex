...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c}{\PYZsh{} We run 100 times}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{p}{(}\PY{n}{testMSE}\PY{p}{,} \PY{n}{trainMSE}\PY{p}{,} \PY{n}{uTestMSE}\PY{p}{,} \PY{n}{uTrainMSE}\PY{p}{)} \PY{o}{=} \PY{n}{getTrainTestMSE}\PY{p}{(}\PY{n}{Us}\PY{p}{,} \PY{n}{Vs}\PY{p}{,} \PY{n}{UserToU}\PY{p}{,} \PY{n}{JokeToV}\PY{p}{)}
\end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{n}{plt}\PY{o}{.}\PY{n}{scatter}\PY{p}{(}\PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{101}\PY{p}{)}\PY{p}{,} \PY{n}{testMSE}\PY{p}{,} \PY{n}{color}\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{b}\PY{l+s}{\PYZsq{}}\PY{p}{,} \PY{n}{label}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{Test Data (Averaged)}\PY{l+s}{\PYZdq{}}\PY{p}{)}

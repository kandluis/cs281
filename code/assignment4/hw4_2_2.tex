...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c}{\PYZsh{} Constant values that won\PYZsq{}t change. The only parameter that changes is K.}
...
{\color{incolor}In [{\color{incolor} }]:} \PY{c}{\PYZsh{} We can calculate these after as long as we return our stack of Us.}
        \PY{k}{def} \PY{n+nf}{getTrainTestLikelihood}\PY{p}{(}\PY{n}{Us}\PY{p}{,} \PY{n}{Vs}\PY{p}{,} \PY{n}{UserToU}\PY{p}{,} \PY{n}{JokeToV}\PY{p}{,} \PY{n}{useEpochs}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{)}\PY{p}{:}
            \PY{l+s+sd}{\PYZsq{}\PYZsq{}\PYZsq{}}
        ...
        \PY{l+s+sd}{    }
        \PY{l+s+sd}{    If epochs is true, then this returns the averages for }
        \PY{l+s+sd}{    \PYZsq{}\PYZsq{}\PYZsq{}}
            ...
            \PY{k}{print} \PY{l+s}{\PYZdq{}}\PY{l+s}{Epochs: \PYZob{}\PYZcb{}}\PY{l+s}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{epochs}\PY{p}{)}
            ...
            \PY{n}{RTrain} \PY{o}{=} \PY{n}{createRatingSet}\PY{p}{(}\PY{n}{train}\PY{p}{,} \PY{n}{n}\PY{p}{,} \PY{n}{m}\PY{p}{,} \PY{n}{UserToU}\PY{p}{,} \PY{n}{JokeToV}\PY{p}{,} \PY{l+s}{\PYZsq{}}\PY{l+s}{R\PYZus{}Train1.out}\PY{l+s}{\PYZsq{}}\PY{p}{)}
            \PY{n}{RTest} \PY{o}{=} \PY{n}{createRatingSet}\PY{p}{(}\PY{n}{test}\PY{p}{,} \PY{n}{n}\PY{p}{,} \PY{n}{m}\PY{p}{,} \PY{n}{UserToU}\PY{p}{,} \PY{n}{JokeToV}\PY{p}{,} \PY{l+s}{\PYZsq{}}\PY{l+s}{R\PYZus{}Test1.out}\PY{l+s}{\PYZsq{}}\PY{p}{)}
        
            
            \PY{k}{if} \PY{n}{useEpochs}\PY{p}{:}
                ...
                \PY{k}{for} \PY{n}{epoch} \PY{o+ow}{in} \PY{n}{epochs}\PY{p}{:}
                    ...
                    \PY{k}{print} \PY{l+s}{\PYZdq{}}\PY{l+s}{Calculating log likelihood of training data for epoch \PYZob{}\PYZcb{}}\PY{l+s}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{epoch}\PY{p}{)}
                    ...
                    \PY{k}{print} \PY{l+s}{\PYZdq{}}\PY{l+s}{Train Log Likelihood for Epoch \PYZob{}\PYZcb{} is \PYZob{}\PYZcb{}}\PY{l+s}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{epoch}\PY{p}{,} \PY{n}{train\PYZus{}avg}\PY{p}{)}
        
                    \PY{k}{print} \PY{l+s}{\PYZdq{}}\PY{l+s}{Calculating log likelihood of testing data for epoch \PYZob{}\PYZcb{}}\PY{l+s}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{epoch}\PY{p}{)}
                    ...
                    \PY{k}{print} \PY{l+s}{\PYZdq{}}\PY{l+s}{Test Log Likelihood for Epoch \PYZob{}\PYZcb{} is \PYZob{}\PYZcb{}}\PY{l+s}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{epoch}\PY{p}{,} \PY{n}{test\PYZus{}avg}\PY{p}{)}
        
                \PY{k}{return} \PY{n}{test\PYZus{}mse}\PY{p}{,} \PY{n}{train\PYZus{}mse}
            \PY{k}{else}\PY{p}{:}
                \PY{n}{UTotal} \PY{o}{=} \PY{n}{Us}\PY{p}{[}\PY{n}{epochs}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{]}
                \PY{n}{VTotal} \PY{o}{=} \PY{n}{Vs}\PY{p}{[}\PY{n}{epochs}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{]}
                \PY{k}{for} \PY{n}{epoch} \PY{o+ow}{in} \PY{n}{epochs}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{:}\PY{p}{]}\PY{p}{:}
                    \PY{n}{UTotal} \PY{o}{+}\PY{o}{=} \PY{n}{Us}\PY{p}{[}\PY{n}{epoch}\PY{p}{]}
                    \PY{n}{VTotal} \PY{o}{+}\PY{o}{=} \PY{n}{Vs}\PY{p}{[}\PY{n}{epoch}\PY{p}{]}
                \PY{n}{UMean} \PY{o}{=} \PY{n}{UTotal} \PY{o}{/} \PY{n+nb}{float}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{epochs}\PY{p}{)}\PY{p}{)}
                \PY{n}{VMean} \PY{o}{=} \PY{n}{VTotal} \PY{o}{/} \PY{n+nb}{float}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{epochs}\PY{p}{)}\PY{p}{)}
                
                \PY{n}{predictions} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{UMean}\PY{p}{,} \PY{n}{VMean}\PY{o}{.}\PY{n}{T}\PY{p}{)}
                
                \PY{n}{trainMSE} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{n}{vectSub}\PY{p}{(}\PY{n}{RTrain}\PY{p}{,} \PY{n}{predictions}\PY{p}{)} \PY{o}{*}\PY{o}{*} \PY{l+m+mi}{2}\PY{p}{)} \PY{o}{/} \PY{n+nb}{float}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{train}\PY{p}{)}\PY{p}{)}
                \PY{n}{testMSE} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{n}{vectSub}\PY{p}{(}\PY{n}{RTest}\PY{p}{,} \PY{n}{predictions}\PY{p}{)} \PY{o}{*}\PY{o}{*} \PY{l+m+mi}{2}\PY{p}{)} \PY{o}{/} \PY{n+nb}{float}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{test}\PY{p}{)}\PY{p}{)}
                
                \PY{k}{return} \PY{n}{testMSE}\PY{p}{,} \PY{n}{trainMSE}
\end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{k}{def} \PY{n+nf}{parametrizeK}\PY{p}{(}\PY{n}{K}\PY{p}{)}\PY{p}{:}
            \PY{n}{testK} \PY{o}{=} \PY{p}{\PYZob{}}\PY{p}{\PYZcb{}}
            \PY{n}{trainK} \PY{o}{=} \PY{p}{\PYZob{}}\PY{p}{\PYZcb{}}
            \PY{k}{for} \PY{n}{k} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{n}{K}\PY{o}{/}\PY{l+m+mi}{2}\PY{p}{)} \PY{o}{+} \PY{p}{[}\PY{n}{K}\PY{p}{]}\PY{p}{:}
                \PY{c}{\PYZsh{} Run the Gibbs sampler on the data}
                \PY{n}{Us}\PY{p}{,} \PY{n}{Vs}\PY{p}{,} \PY{n}{UserToU}\PY{p}{,} \PY{n}{UserToV}\PY{p}{,} \PY{n}{JokeToU}\PY{p}{,} \PY{n}{JokeToV} \PY{o}{=} \PY{n}{gibbsSampling}\PY{p}{(}\PY{n}{k}\PY{p}{,} \PY{l+m+mi}{100}\PY{p}{)}
                
                \PY{c}{\PYZsh{} Calculate the log likelihood}
                \PY{n}{test}\PY{p}{,} \PY{n}{train} \PY{o}{=} \PY{n}{getTrainTestLikelihood}\PY{p}{(}\PY{n}{Us}\PY{p}{,} \PY{n}{Vs}\PY{p}{,} \PY{n}{UserToU}\PY{p}{,} \PY{n}{JokeToV}\PY{p}{)}
                
                \PY{n}{testK}\PY{p}{[}\PY{n}{k}\PY{p}{]} \PY{o}{=} \PY{n}{test}
                \PY{n}{trainK}\PY{p}{[}\PY{n}{k}\PY{p}{]} \PY{o}{=} \PY{n}{train}
                
                \PY{k}{print} \PY{l+s}{\PYZdq{}}\PY{l+s}{Finished for K = \PYZob{}\PYZcb{}}\PY{l+s}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{k}\PY{p}{)}
            \PY{k}{return} \PY{n}{testK}\PY{p}{,} \PY{n}{trainK}
\end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{n}{testMSE}\PY{p}{,} \PY{n}{trainMSE} \PY{o}{=} \PY{n}{parametrizeK}\PY{p}{(}\PY{l+m+mi}{10}\PY{p}{)}
\end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{n}{trainMSE}\PY{o}{.}\PY{n}{keys}\PY{p}{(}\PY{p}{)}
\end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c}{\PYZsh{} Now we just need to plot the results for the values of K}
        \PY{k+kn}{from} \PY{n+nn}{matplotlib.pyplot} \PY{k+kn}{import} \PY{n}{cm} 
        
        \PY{n}{K} \PY{o}{=} \PY{l+m+mi}{10}
        \PY{n}{color}\PY{o}{=}\PY{n+nb}{iter}\PY{p}{(}\PY{n}{cm}\PY{o}{.}\PY{n}{rainbow}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{linspace}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{K}\PY{p}{)}\PY{p}{)}\PY{p}{)}
        \PY{k}{for} \PY{n}{k} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{)} \PY{o}{+} \PY{p}{[}\PY{l+m+mi}{10}\PY{p}{]}\PY{p}{:}
            \PY{n}{plt}\PY{o}{.}\PY{n}{scatter}\PY{p}{(}\PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{101}\PY{p}{)}\PY{p}{,} \PY{n}{testMSE}\PY{p}{[}\PY{n}{k}\PY{p}{]}\PY{p}{,} \PY{n}{color}\PY{o}{=}\PY{n+nb}{next}\PY{p}{(}\PY{n}{color}\PY{p}{)}\PY{p}{,} \PY{n}{label}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{Test Data (K = \PYZob{}\PYZcb{})}\PY{l+s}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{k}\PY{p}{)}\PY{p}{)}
            \PY{n}{plt}\PY{o}{.}\PY{n}{scatter}\PY{p}{(}\PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{101}\PY{p}{)}\PY{p}{,} \PY{n}{trainMSE}\PY{p}{[}\PY{n}{k}\PY{p}{]}\PY{p}{,} \PY{n}{color}\PY{o}{=}\PY{n+nb}{next}\PY{p}{(}\PY{n}{color}\PY{p}{)}\PY{p}{,} \PY{n}{label}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{Train Data (K = \PYZob{}\PYZcb{})}\PY{l+s}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{k}\PY{p}{)}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{MSE of Test and Training Data}\PY{l+s}{\PYZdq{}}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{Dimension of Latent Variables}\PY{l+s}{\PYZdq{}}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{ylabel}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{MSE}\PY{l+s}{\PYZdq{}}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{n}{np}\PY{o}{.}\PY{n}{concatenate}\PY{p}{(}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{]}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
